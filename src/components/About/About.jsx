      ...
      <div className={styles.content}>
        <div className={styles.subtitle}>
          ...
          <p>
            ...
            photography, which has allowed me to capture unique perspectives and
            moments.
          </p>
          <p>
          ...
          <p>
            ...
            database management systems such as MongoDB, Express.js, and MySQL.
          </p>
          <p>
            Driven by a relentless pursuit of excellence and a commitment to
            continuous learning, I am excited to contribute my diverse skill set
            and creative problem-solving abilities to any project or team.
          </p>
        </div>
      </div>
    </section>
